    ...
    <section className="py-20 relative">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4 text-coral-600 dark:text-coral-400">
            {t('title')}
          </h2>
          ...
          <Card className="group hover:shadow-xl transition-all duration-300 border-0 shadow-lg bg-white/90 dark:bg-charcoal-800/90 backdrop-blur-sm hover:bg-white/95 dark:hover:bg-charcoal-800/95">
            <CardHeader className="pb-4">
              ...
              <Link href={`/${locale}/blog/audio-summary-how-it-works`} target="_blank" rel="noopener noreferrer" className="block">
                <CardTitle className="text-lg group-hover:text-coral-600 transition-colors duration-300 cursor-pointer hover:text-coral-600 line-clamp-2">
                  {t('post1.title')}
                </CardTitle>
              </Link>
            ...
            <CardContent className="pt-0">
              <Link href={`/${locale}/blog/audio-summary-how-it-works`} target="_blank" rel="noopener noreferrer">
                <Button variant="ghost" className="group p-0 text-coral-600 dark:text-coral-400 hover:text-white hover:bg-coral-600 dark:hover:bg-coral-500 px-4 py-2 rounded-lg transition-all duration-300">
                  {t('readMore')}
